    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotasID = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AlunoID = table.Column<long>(type: "bigint", nullable: false),
                    Matematica = table.Column<double>(type: "float", nullable: false),
                    Portugues = table.Column<double>(type: "float", nullable: false),
                    Historia = table.Column<double>(type: "float", nullable: false),
                    Geografia = table.Column<double>(type: "float", nullable: false),
                    Ingles = table.Column<double>(type: "float", nullable: false),
                    Biologia = table.Column<double>(type: "float", nullable: false),
                    Filosofia = table.Column<double>(type: "float", nullable: false),
                    Fisica = table.Column<double>(type: "float", nullable: false),
                    Quimica = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
